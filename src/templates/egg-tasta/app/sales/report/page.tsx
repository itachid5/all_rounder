...
export default function SalesReportPage() {
  const reports = [
    { title: "Daily Sales", icon: Calendar, description: "View sales made today." },
    { title: "Monthly Sales", icon: BarChart3, description: "Analyze sales trends over the month." },
    { title: "Customer-wise Sales", icon: Users, description: "Sales broken down by customer." },
    { title: "Product-wise Sales", icon: PackageOpen, description: "Detailed product volume analysis." },
    { title: "Sales Summary", icon: PieChart, description: "High-level summary of total sales." },
  ];
    ...
    <div className="space-y-6">
      ...
      <div>
        <nav className="flex items-center text-sm text-slate-500 dark:text-slate-400 mb-2">
          ...
          <ChevronRight className="h-4 w-4 mx-1" />
          <span className="text-slate-900 dark:text-slate-100 font-medium">Sales Report</span>
        </nav>
        
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Sales Report</h1>
        <p className="text-slate-500 dark:text-slate-400 mt-1">Analyze your sales data and generate reports.</p>
      </div>
