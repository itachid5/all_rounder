...
import { getExpenseCategoriesAction } from "@/templates/egg-tasta/actions/expenses";
import { NewExpenseClient } from "@/templates/egg-tasta/components/expenses/new-expense-client";
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">Record a new business expense.</p>
      </div>

      <NewExpenseClient categories={categoriesRes.data || []} />
    </div>
  );
}
