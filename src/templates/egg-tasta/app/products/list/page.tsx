...
import { ProductListClient } from "@/templates/egg-tasta/components/products/product-list-client";
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Product List</h1>
        <p className="text-slate-500 dark:text-slate-400 mt-1">Read-only product catalog listing with search, filters, and export options.</p>
      </div>
