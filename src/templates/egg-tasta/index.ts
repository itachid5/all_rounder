...
const contract: TemplateContract = {
  ...
  routes: [
    ...
    "settings/invoice", "settings/profile", "settings/backup", "settings/company", "settings/tax", "settings/financial", "settings/preferences", "settings/audit", "settings/notifications", "settings", "settings/import-export",
    ...
    "notifications/center", "notifications/email", "notifications/whatsapp", "notifications/sms", "notifications/dues", "notifications/automation", "notifications/expiry", "notifications/low-stock",
    "products/manage", "products", "products/new", "modules", "roles",
    "customers/manage", "customers/due", "customers/new", "customers/ledger",
    "accounts/mobile", "accounts/cash", "accounts/transfer", "accounts/bank", "accounts/bank/transactions", "accounts/ledger", "accounts/report",
